...
const Login = () => {
  ...
  // Recuperación de contraseña - CON VALIDACIÓN MEJORADA
    ...
    try {
      ...
      if (error) {
        if (
          ...
          showMessage("❌ Este correo electrónico no está registrado", "error");
        } else {
      ...
      showMessage(
        "✅ ¡Enlace enviado! Revisa tu email y carpeta de spam.",
        "success"
      );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-cyan-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        {/* Formulario */}
        <div className="p-6">
          {/* ELIMINADO COMPLETAMENTE EL BOTÓN DE GOOGLE Y LA LÍNEA DIVISORIA */}
