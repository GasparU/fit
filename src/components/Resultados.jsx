...
export const Resultados = ({
  ...
  const getCardioDisplayValues = () => {
    ...
    // USAR EL NIVEL DEL USUARIO SI ESTÁ DISPONIBLE, de lo contrario usar el del cardioResult
    const nivel = userData?.nivelCardio || cardioResult?.nivel || "Moderado";
 ...
 const componentMap = {
   ...
   tdee: hasValue(tdeeResult) && (
     <div className="p-2 rounded-md bg-teal-50 border border-teal-200 transition-all duration-500 ease-in-out">
       <div className="cursor-grab active:cursor-grabbing py-1">
       ...
       <div className="mt-2 bg-teal-100 p-2 rounded-md">
         ...
         <p className="text-teal-700 text-xs mt-1">
           Este es el gasto energético base sin incluir el efecto térmico de los
           alimentos
         </p>
       </div>
     </div>
   ...
   energiaTotal: energiaTotalResult && (
     <div className="p-2 rounded-md bg-blue-50 border border-blue-200 transition-all duration-500 ease-in-out">
       <div className="cursor-grab active:cursor-grabbing py-1">
   ...
   grasa: hasValue(grasaCorporalResult) && (
     <div className="p-2 rounded-md bg-amber-50 border border-amber-200 transition-all duration-500 ease-in-out">
       <div className="cursor-grab active:cursor-grabbing py-1">
         <h3
   ...
   cardio: cardioDisplayValues && zonaCardio && (
     <div
       className={`p-2 rounded-md border transition-all duration-500 ease-in-out ${zonaCardio.bgColor} ${zonaCardio.borderColor}`}
     >
       <div className="cursor-grab active:cursor-grabbing py-1">
         <h3
